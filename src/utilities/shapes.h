...
Mesh sphereCube(glm::vec3 scale = glm::vec3(1), glm::vec2 textureScale = glm::vec2(1), bool tilingTextures = false, bool inverted = false, glm::vec3 textureScale3d = glm::vec3(1), float radius = 1.0f, glm::vec3 cameraPosition = glm::vec3(1));
Mesh Screenplane();